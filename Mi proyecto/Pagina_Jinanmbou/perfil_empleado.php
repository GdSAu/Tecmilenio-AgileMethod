  ...
  <body class="bg-success" style="--bs-bg-opacity: .60;">
    <nav class="navbar navbar-expand-lg bg-light text-dark">
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
          <ul class="navbar-nav">
            <li class="nav-item"><a class="nav-link disabled" href="menu.php">Menu</a></li>
          </ul>
        </div>
      </div>
    </nav>
    ...
    <main class="container">
      <div class="w-100 text-center">
        <div class="big-title">¿Qué sección eres?</div>

        <div class="sections mx-auto">
          <a href="pedidos.php" class="section-btn caja" role="button" aria-label="Ir a Caja">
            Caja
          </a>

          <a href="entrega.php" class="section-btn cocina" role="button" aria-label="Ir a Cocina/Entregas">
            Cocina
          </a>
        </div>
