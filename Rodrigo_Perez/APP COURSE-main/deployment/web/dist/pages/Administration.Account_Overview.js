...
import { DatagridWidgetModule } from '../Datagrid-J-DrY2e8.js';
import { DatagridDateFilterWidgetModule, DatagridTextFilterWidgetModule } from '../DatagridTextFilter-BP7xm5hU.js';
import { DatagridDropdownFilterWidgetModule } from '../DatagridDropdownFilter-B85bC_I4.js';
import { useLegacyResize, getBox } from '../DmsI6saM-DYa5cVH3.js';
import { usePersistentState } from '../FeedbackModule.ACT_Open_Feedback_Modal-Cg7QdmhI.js';
import { isRightToLeft } from '../EJisauA3-k7KfvnWZ.js';
                              ...
                              /* @__PURE__ */ React.createElement(
                                $Datagrid,
                                {
                                  ...
                                  datasource: DatabaseObjectListProperty({
                                    ...
                                    "operationId": "NbrxW9kDrlqxSp6og37Naw",
                                    "sort": [
                                      [
                                        "FullName",
                                        "asc"
                                        ...
                                        /* @__PURE__ */ React.createElement(
                                          $DatagridDropdownFilter,
                                          {
                                            ...
                                            refOptions: DatabaseObjectListProperty({
                                              "dataSourceId": "p.15",
                                              "entity": "System.UserRole",
                                              "operationId": "OZHWYJKxDFS8oYkXmZ/xIg",
                                              "sort": [
                                                [
                                                  "Name",
                                                  "asc"
                                              ...
                                              contents: [
                                                /* @__PURE__ */ React.createElement(
                                                  $ActionButton,
                                                  {
                                                    ...
                                                    action: ActionProperty({
                                                      "action": { "type": "deleteObject", "argMap": { "$object": { "widget": "p.Administration.Account_Overview.dataGrid21", "source": "object" } }, "config": { "closePage": false, "operationId": "dYhc2GUzeFyQGW/hh0CRmQ" }, "disabledDuringExecution": true },
                                                      "abortOnServerValidation": true
                                                    })
                                                  }
                                                )
                                        ...
                                        contents: [
                                          /* @__PURE__ */ React.createElement(
                                            $ActionButton,
                                            {
                                              ...
                                              icon: void 0,
                                              action: ActionProperty({
                                                "action": { "type": "callMicroflow", "argMap": {}, "config": { "operationId": "XNXBTEW79lu4Fe4Yh4Xqdw", "validate": "view", "allowedRoles": ["Administrator"] }, "disabledDuringExecution": true },
                                                "abortOnServerValidation": true
                                              })
                                            }
                                          )
                                        ...
                                        contents: [
                                          /* @__PURE__ */ React.createElement(
                                            $ActionButton,
                                            {
                                              ...
                                              icon: void 0,
                                              action: ActionProperty({
                                                "action": { "type": "callMicroflow", "argMap": {}, "config": { "operationId": "D65MWdbhKVSJI+15NZatQQ", "validate": "view", "allowedRoles": ["Administrator"] }, "disabledDuringExecution": true },
                                                "abortOnServerValidation": true
                                              })
                                            }
                                          )
