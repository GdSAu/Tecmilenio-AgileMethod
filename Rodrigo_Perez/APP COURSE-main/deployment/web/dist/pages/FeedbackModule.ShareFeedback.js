...
import { Label } from '../Label-QbX1b2o9.js';
import { Text } from '../Text-DNEB1YEo.js';
import { debounce, TextBox } from '../TextBox-Cy1339A_.js';
...
const DS_Feedback_Populate = {
  ...
  "instructions": [
    ...
    },
    {
      ...
      "operationId": "RnzGSTJvrluBwjAK7yS+ig",
      "parameters": [
        {
          "name": "Feedback",
          "value": {
...
const ACT_Feedback_TriggerScreenshotMode = {
  ...
  "instructions": [
    ...
    {
      "type": "commitObjects",
      "operationId": "G3uqyhUdWV6waU40mLYQJg",
      "inputVar": "Feedback"
    },
    {
      "type": "jump",
  ...
  "instructions": [
    {
      ...
      "operationId": "8F5Onarp+lmT1K4Yu2vHfA",
      "parameters": [
        {
          "name": "Feedback",
          "value": {
    ...
    },
    {
      ...
      "operationId": "WWN7IXLvH1qs1SKJBPymQg",
      "parameters": [
        {
          "name": "Feedback",
          "value": {
                    ...
                    /* @__PURE__ */ React.createElement(
                      $DataView,
                      {
                        ...
                        object: NanoflowObjectProperty({
                          "dataSourceId": "p.20",
                          "editable": true,
                          "source": { "nanoflow": () => DS_Feedback_Populate, "allowedRoles": ["Teacher"] },
                          "argMap": {}
                        }),
                                      ...
                                      /* @__PURE__ */ React.createElement(
                                        $TextBox,
                                        {
                                          ...
                                          inputValue: AttributeProperty({
                                            ...
                                            "entity": "FeedbackModule.Feedback",
                                            "attribute": "Subject",
                                            "onChange": { "type": "callNanoflow", "argMap": { "Feedback": { "widget": "p.FeedbackModule.ShareFeedback.dataView5", "source": "object" } }, "config": { "nanoflow": () => OCH_Feedback_SaveToLocalStorage, "allowedRoles": ["Teacher"] }, "disabledDuringExecution": false },
                                            "isList": false,
                                            "validation": null,
                                            "formatting": {}
                                          }),
                                ...
                                /* @__PURE__ */ React.createElement(
                                  $ConditionalVisibilityWrapper,
                                  {
                                    ...
                                    visible: ExpressionProperty({
                                      "expression": { "expr": { "type": "function", "name": "_hasSomeRole", "parameters": [{ "type": "literal", "value": "Teacher" }] }, "args": {} }
                                    }),
                                    contents: [
                                      /* @__PURE__ */ React.createElement(
                                        $ActionButton,
                                        {
                                          ...
                                          action: ActionProperty({
                                            "action": { "type": "callNanoflow", "argMap": { "Feedback": { "widget": "p.FeedbackModule.ShareFeedback.dataView5", "source": "object" } }, "config": { "nanoflow": () => ACT_Feedback_TriggerScreenshotMode, "allowedRoles": ["Teacher"] }, "disabledDuringExecution": true },
                                    ...
                                    contents: [
                                      /* @__PURE__ */ React.createElement(
                                        $ActionButton,
                                        {
                                          ...
                                          action: ActionProperty({
                                            "action": { "type": "callNanoflow", "argMap": { "Feedback": { "widget": "p.FeedbackModule.ShareFeedback.dataView5", "source": "object" } }, "config": { "nanoflow": () => ACT_Feedback_UploadImage, "allowedRoles": ["Teacher"] }, "disabledDuringExecution": true },
                                            "abortOnServerValidation": true
                                          })
                                        }
                                      )
                                                ...
                                                contents: [
                                                  /* @__PURE__ */ React.createElement(
                                                    $ActionButton,
                                                    {
                                                      ...
                                                      action: ActionProperty({
                                                        "action": { "type": "callNanoflow", "argMap": { "Feedback": { "widget": "p.FeedbackModule.ShareFeedback.dataView5", "source": "object" } }, "config": { "nanoflow": () => ACT_Feedback_ClearImage, "allowedRoles": ["Teacher"] }, "disabledDuringExecution": true },
                                                        "abortOnServerValidation": true
                                                      })
                                                    }
                                                  )
                                    ...
                                    contents: [
                                      /* @__PURE__ */ React.createElement(
                                        $ActionButton,
                                        {
                                          ...
                                          icon: void 0,
                                          action: ActionProperty({
                                            "action": { "type": "callNanoflow", "argMap": { "Feedback": { "widget": "p.FeedbackModule.ShareFeedback.dataView5", "source": "object" } }, "config": { "nanoflow": () => ACT_Feedback_ClearForm, "allowedRoles": ["Teacher"] }, "disabledDuringExecution": true },
                                            "abortOnServerValidation": true
                                          })
                                        }
                                      )
                                    ...
                                    contents: [
                                      /* @__PURE__ */ React.createElement(
                                        $ActionButton,
                                        {
                                          ...
                                          icon: void 0,
                                          action: ActionProperty({
                                            "action": { "type": "callNanoflow", "argMap": { "Feedback": { "widget": "p.FeedbackModule.ShareFeedback.dataView5", "source": "object" } }, "config": { "nanoflow": () => ACT_SubmitFeedback, "allowedRoles": ["Teacher"] }, "disabledDuringExecution": true },
                                            "abortOnServerValidation": true
                                          })
                                        }
                                      )
...
const cancelChangesOperationId = "3v2glRywoVOAIenbjQD8kg";
const style = {};
const parameters = {};
const content = {
  ...content$1,
