import { reactExports, jsxRuntimeExports, asPluginWidgets, selectTranslation } from '../index-CAr0kpKK.js';
...
import { FocusContainer, DatePicker } from '../DatePicker-BMohDKHX.js';
...
const { $Div, $FormGroup, $Combobox, $DataView, $TextBox, $DatePicker, $RadioButtonGroup, $ConditionalVisibilityWrapper, $ActionButton } = asPluginWidgets({ Div, FormGroup, Combobox, DataView, TextBox, DatePicker, RadioButtonGroup, ConditionalVisibilityWrapper, ActionButton });
                          ...
                          /* @__PURE__ */ React.createElement(
                            $Combobox,
                            {
                              ...
                              optionsSourceAssociationDataSource: DatabaseObjectListProperty({
                                ...
                                "entity": "MyFirstModule.Trainee",
                                "scope": "$Registration",
                                "operationId": "HprO8g8Z8VCv6iC/LT2avg",
                                "sort": []
                              }),
                        ...
                        footer: [
                                ...
                                /* @__PURE__ */ React.createElement(
                                  $ActionButton,
                                  {
                                    ...
                                    action: ActionProperty({
                                      "action": { "type": "callMicroflow", "argMap": { "Registration": { "widget": "$Registration", "source": "object" } }, "config": { "operationId": "4YUa7+dzj1iEsZCgqzhwnQ", "validate": "view", "allowedRoles": ["Administrator"] }, "disabledDuringExecution": true },
                          ...
                          /* @__PURE__ */ React.createElement(
                            $ActionButton,
                            {
                              ...
                              icon: void 0,
                              action: ActionProperty({
                                "action": { "type": "cancelChanges", "argMap": {}, "config": { "operationId": "3uU7RlKwTlap/2KtCRSBIg", "closePage": true }, "disabledDuringExecution": true },
                                "abortOnServerValidation": true
                              })
                            }
                          )
...
const classes = "";
const autofocus = "off";
const cancelChangesOperationId = "oI7FRTC6lF+Oqt1LCainWg";
const style = {};
