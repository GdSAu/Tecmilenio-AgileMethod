                            ...
                            <$DataView key="p.Administration.Account_New.dataView2"
                                ...
                                body={[
                                    <$DataView key="p.Administration.Account_New.dataView1"
                                        ...
                                        object={AssociationObjectProperty({
                                            ...
                                            "operationId": "lGCst55o+l6Ih369qDlP1Q"
                                        })}
                                        emptyMessage={TextProperty({
                                            "value": t([
                                                ""
                                                ...
                                                control={[
                                                    <$Combobox key="p.Administration.Account_New.comboBox1"
                                                        ...
                                                        optionsSourceAssociationDataSource={DatabaseObjectListProperty({
                                                            ...
                                                            "scope": "p.Administration.Account_New.dataView1",
                                                            "operationId": "NP39oIPrq1qZtmgOcljdrA",
                                                            "sort": [
                                                                [
                                                                    "Name",
                                                                    "asc"
                                                ...
                                                control={[
                                                    <$Combobox key="p.Administration.Account_New.comboBox3"
                                                        ...
                                                        optionsSourceAssociationDataSource={DatabaseObjectListProperty({
                                                            ...
                                                            "scope": "p.Administration.Account_New.dataView1",
                                                            "operationId": "76bU08y6LVStcB170xd53w",
                                                            "sort": []
                                                        })}
                                                        optionsSourceAssociationCaptionType={"attribute"}
                                                        optionsSourceAssociationCaptionAttribute={ListAttributeProperty({
                                                ...
                                                control={[
                                                    <$Combobox key="p.Administration.Account_New.comboBox2"
                                                        ...
                                                        optionsSourceAssociationDataSource={DatabaseObjectListProperty({
                                                            ...
                                                            "scope": "p.Administration.Account_New.dataView1",
                                                            "operationId": "yKK6WBgjG1muzhtsHfqlUg",
                                                            "sort": [
                                                                [
                                                                    "RawOffset",
                                                                    "asc"
                                ...
                                footer={[
                                        ...
                                        contents={[
                                            <$ActionButton key="p.Administration.Account_New.microflowButton1"
                                                ...
                                                action={ActionProperty({
                                                    "action": { "type": "callMicroflow", "argMap": { "AccountPasswordData": { "widget": "$AccountPasswordData", "source": "object" } }, "config": { "operationId": "WAJ5ZrY/UVGly0HlG977bQ", "validate": "view", "allowedRoles": [ "Administrator" ] }, "disabledDuringExecution": false },
                                    ...
                                    <$ActionButton key="p.Administration.Account_New.cancelButton1"
                                        ...
                                        icon={undefined}
                                        action={ActionProperty({
                                            "action": { "type": "cancelChanges", "argMap": {}, "config": { "operationId": "BLv/EkfRpVihh5kJ0V83NQ", "closePage": true }, "disabledDuringExecution": true },
                                            "abortOnServerValidation": true
                                        })} />
                                ]} />
                        ]} />
...
export const cancelChangesOperationId = "RoEyGyo2f1uQ+xkA1O0dtw";
export const closeButton = "p.Administration.Account_New.cancelButton1";
export const style = {};
export const parameters = {"$AccountPasswordData":"object"};
