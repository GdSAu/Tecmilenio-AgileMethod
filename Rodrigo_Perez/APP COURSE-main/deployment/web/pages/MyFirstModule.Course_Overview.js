                                ...
                                contents={[
                                    <$ActionButton key="p.MyFirstModule.Course_Overview.actionButton1"
                                        ...
                                        action={ActionProperty({
                                            "action": { "type": "createObject", "argMap": {}, "config": { "entity": "MyFirstModule.Course", "operationId": "uvtb3zax+Fm4AWmP5vEzEQ", "pageSettings": { "name": "MyFirstModule/Course_NewEdit.page.xml", "location": "content", "allowedRoles": [ "Administrator" ] }, "allowedRoles": [ "Administrator" ], "objectParameter": "param$Course" }, "disabledDuringExecution": true },
                                ...
                                content={[
                                    <$Gallery key="p.MyFirstModule.Course_Overview.gallery1"
                                        ...
                                        datasource={DatabaseObjectListProperty({
                                            ...
                                            "operationId": "8viGpF8uZVWza0hnocAw9A",
                                            "sort": []
                                        })}
                                        ...
                                        content={TemplatedWidgetProperty({
                                            ...
                                            "editable": false,
                                            "children": () => [
                                                <$Container key="p.MyFirstModule.Course_Overview.container4"
                                                    ...
                                                    onClick={undefined}
                                                    content={[
                                                        <$Container key="p.MyFirstModule.Course_Overview.container5"
                                                            ...
                                                            onClick={undefined}
                                                            content={[
                                                                <$Text key="p.MyFirstModule.Course_Overview.text11"
                                                                    ...
                                                                    renderMode={"h4"} />,
                                                                <$Text key="p.MyFirstModule.Course_Overview.text42"
                                                                    $widgetId="p.MyFirstModule.Course_Overview.text42"
                                                                    class={"mx-name-text42 spacing-outer-bottom-none"}
                                                                    style={undefined}
                                                                    caption={t([
                                                                        ExpressionProperty({
                                                                            "expression": { "expr": { "type": "literal", "value": "{Duration} day(s)" }, "args": {} }
                                                                        })
                                                                    ])}
                                                                    renderMode={"p"} />,
                                                                <$Text key="p.MyFirstModule.Course_Overview.text43"
                                                                    $widgetId="p.MyFirstModule.Course_Overview.text43"
                                                                    class={"mx-name-text43 spacing-outer-bottom-none"}
                                                                    style={undefined}
                                                                    caption={t([
                                                                        ExpressionProperty({
                                                                            "expression": { "expr": { "type": "literal", "value": "Price: {Price}" }, "args": {} }
                                                                        })
                                                                    ])}
                                                                    renderMode={"p"} />
                                                            ]}
                                                            ariaHidden={false} />,
                                                        <$ConditionalVisibilityWrapper key="p.MyFirstModule.Course_Overview.actionButton2$visibility"
                                                            $widgetId="p.MyFirstModule.Course_Overview.actionButton2$visibility"
                                                            visible={ExpressionProperty({
                                                                "expression": { "expr": { "type": "function", "name": "_hasSomeRole", "parameters": [ { "type": "literal", "value": "Administrator" } ] }, "args": {} }
                                                            })}
                                                            contents={[
                                                                <$ActionButton key="p.MyFirstModule.Course_Overview.actionButton2"
                                                                    ...
                                                                    action={ActionProperty({
                                                                        "action": { "type": "callMicroflow", "argMap": { "Course": { "widget": "p.MyFirstModule.Course_Overview.gallery1", "source": "object" } }, "config": { "operationId": "jUe4JYUGUlaU0iyaR3xTUg", "validate": "view", "allowedRoles": [ "Administrator" ] }, "disabledDuringExecution": true },
                                                                        "abortOnServerValidation": true
                                                                    })} />
                                                            ]} />,
                                                        <$ActionButton key="p.MyFirstModule.Course_Overview.actionButton5"
