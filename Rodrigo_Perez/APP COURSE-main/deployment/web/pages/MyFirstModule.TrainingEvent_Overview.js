...
import * as GalleryWidgetModule from "C:/Users/P4/Mendix/APP COURSE-main/deployment/web/widgets/com/mendix/widget/web/gallery/Gallery.mjs";
                                ...
                                content={[
                                    <$Gallery key="p.MyFirstModule.TrainingEvent_Overview.gallery1"
                                        ...
                                        datasource={DatabaseObjectListProperty({
                                            ...
                                            "operationId": "7Vfw3SZg9lyD3ooH++qZSg",
                                            "sort": []
                                        })}
                                        ...
                                        content={TemplatedWidgetProperty({
                                            ...
                                            "editable": false,
                                            "children": () => [
                                                <$Container key="p.MyFirstModule.TrainingEvent_Overview.container4"
                                                    ...
                                                    onClick={ActionProperty({
                                                        "action": { "type": "openPage", "argMap": { "param$TrainingEvent": { "widget": "p.MyFirstModule.TrainingEvent_Overview.gallery1", "source": "object" } }, "config": { "name": "MyFirstModule/TrainingEvent_NewEdit.page.xml", "location": "modal", "resizable": true, "allowedRoles": [ "Administrator" ] }, "disabledDuringExecution": true }
                                                    })}
                                                    content={[
                                                        <$Container key="p.MyFirstModule.TrainingEvent_Overview.container5"
                                                            ...
                                                            onClick={undefined}
                                                            content={[
                                                                <$Text key="p.MyFirstModule.TrainingEvent_Overview.text11"
                                                                    ...
                                                                    renderMode={"h4"} />,
                                                                <$Text key="p.MyFirstModule.TrainingEvent_Overview.text42"
                                                                    ...
                                                                    renderMode={"p"} />,
                                                                <$Text key="p.MyFirstModule.TrainingEvent_Overview.text43"
                                                                    ...
                                                                    renderMode={"p"} />,
                                                                <$Text key="p.MyFirstModule.TrainingEvent_Overview.text44"
                                                                    $widgetId="p.MyFirstModule.TrainingEvent_Overview.text44"
                                                                    class={"mx-name-text44 spacing-outer-bottom-none"}
                                                                    style={undefined}
                                                                    caption={t([
                                                                        ExpressionProperty({
                                                                            "expression": { "expr": { "type": "function", "name": "+", "parameters": [ { "type": "literal", "value": "Locate at: " }, { "type": "variable", "variable": "currentObject", "path": "MyFirstModule.TrainingEvent_Location/MyFirstModule.Location/Address" } ] }, "args": { "currentObject": { "widget": "p.MyFirstModule.TrainingEvent_Overview.gallery1", "source": "object" } } }
                                                                        })
                                                                    ])}
                                                                    renderMode={"p"} />,
                                                                <$ConditionalVisibilityWrapper key="p.MyFirstModule.TrainingEvent_Overview.text45$visibility"
                                                                    $widgetId="p.MyFirstModule.TrainingEvent_Overview.text45$visibility"
                                                                    visible={ExpressionProperty({
                                                                    ...
                                                                    contents={[
                                                                        <$Text key="p.MyFirstModule.TrainingEvent_Overview.text45"
                                                                            $widgetId="p.MyFirstModule.TrainingEvent_Overview.text45"
                                                        ...
                                                        <$ConditionalVisibilityWrapper key="p.MyFirstModule.TrainingEvent_Overview.actionButton2$visibility"
                                                            ...
                                                            contents={[
                                                                <$ActionButton key="p.MyFirstModule.TrainingEvent_Overview.actionButton2"
                                                                    ...
                                                                    icon={undefined}
                                                                    action={ActionProperty({
                                                                        "action": { "type": "createObject", "argMap": {}, "config": { "entity": "MyFirstModule.Registration", "operationId": "6nFmg61i3lWI5PmEtZ75Bw", "pageSettings": { "name": "MyFirstModule/Registration_NewEdit.page.xml", "location": "modal", "resizable": true, "allowedRoles": [ "Administrator" ] }, "allowedRoles": [ "Administrator" ], "objectParameter": "param$Registration" }, "disabledDuringExecution": true },
                                                                        "abortOnServerValidation": true
                                                                    })} />
                                                            ]} />,
                                                        <$ConditionalVisibilityWrapper key="p.MyFirstModule.TrainingEvent_Overview.actionButton5$visibility"
                                                            $widgetId="p.MyFirstModule.TrainingEvent_Overview.actionButton5$visibility"
                                                            visible={ExpressionProperty({
                                                                "expression": { "expr": { "type": "function", "name": "_hasSomeRole", "parameters": [ { "type": "literal", "value": "Administrator" }, { "type": "literal", "value": "Teacher" } ] }, "args": {} }
                                                            })}
                                                            contents={[
                                                                <$ActionButton key="p.MyFirstModule.TrainingEvent_Overview.actionButton5"
                                                        ...
                                                        <$ConditionalVisibilityWrapper key="p.MyFirstModule.TrainingEvent_Overview.actionButton3$visibility"
                                                            $widgetId="p.MyFirstModule.TrainingEvent_Overview.actionButton3$visibility"
                                                            visible={ExpressionProperty({
                                                                "expression": { "expr": { "type": "function", "name": "_hasSomeRole", "parameters": [ { "type": "literal", "value": "Administrator" } ] }, "args": {} }
                                                            })}
                                                            contents={[
                                                                <$ActionButton key="p.MyFirstModule.TrainingEvent_Overview.actionButton3"
                                                                    ...
                                                                    action={ActionProperty({
                                                                        "action": { "type": "deleteObject", "argMap": { "$object": { "widget": "p.MyFirstModule.TrainingEvent_Overview.gallery1", "source": "object" } }, "config": { "closePage": true, "operationId": "uDyBT/bjDVOthacOvvuLTw" }, "disabledDuringExecution": true },
                                                                        "abortOnServerValidation": true
                                                                    })} />
                                                            ]} />
                                                    ]}
