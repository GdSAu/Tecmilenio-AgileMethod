                                ...
                                contents={[
                                    <$ActionButton key="p.MyFirstModule.Trainee_Overview.actionButton1"
                                        ...
                                        action={ActionProperty({
                                            "action": { "type": "createObject", "argMap": {}, "config": { "entity": "MyFirstModule.Trainee", "operationId": "qRF8pkrBTViJvQ6NleueYg", "pageSettings": { "name": "MyFirstModule/Trainee_NewEdit.page.xml", "location": "content", "allowedRoles": [ "Administrator" ] }, "allowedRoles": [ "Administrator" ], "objectParameter": "param$Trainee" }, "disabledDuringExecution": true },
                                ...
                                content={[
                                    <$Gallery key="p.MyFirstModule.Trainee_Overview.gallery1"
                                        ...
                                        datasource={DatabaseObjectListProperty({
                                            ...
                                            "operationId": "xv9DoILZUl6RmbAuS1DyOg",
                                            "sort": []
                                        })}
                                        ...
                                        content={TemplatedWidgetProperty({
                                            ...
                                            "editable": false,
                                            "children": () => [
                                                <$Container key="p.MyFirstModule.Trainee_Overview.container4"
                                                    ...
                                                    onClick={undefined}
                                                    content={[
                                                        <$Container key="p.MyFirstModule.Trainee_Overview.container5"
                                                            ...
                                                            onClick={undefined}
                                                            content={[
                                                                <$Text key="p.MyFirstModule.Trainee_Overview.text11"
                                                                    ...
                                                                    renderMode={"h4"} />,
                                                                <$Text key="p.MyFirstModule.Trainee_Overview.text42"
                                                                    ...
                                                                    renderMode={"p"} />,
                                                                <$Text key="p.MyFirstModule.Trainee_Overview.text43"
                                                                    $widgetId="p.MyFirstModule.Trainee_Overview.text43"
                                                                    class={"mx-name-text43 spacing-outer-bottom-none"}
                                                                    style={undefined}
                                                                    caption={t([
                                                                        ExpressionProperty({
                                                                            "expression": { "expr": { "type": "literal", "value": "EmailAddress" }, "args": {} }
                                                                        })
                                                                    ])}
                                                                    renderMode={"p"} />
                                                            ]}
                                                            ariaHidden={false} />,
                                                        <$ActionButton key="p.MyFirstModule.Trainee_Overview.actionButton5"
                                                            ...
                                                            action={undefined} />,
                                                        <$ConditionalVisibilityWrapper key="p.MyFirstModule.Trainee_Overview.actionButton2$visibility"
                                                            $widgetId="p.MyFirstModule.Trainee_Overview.actionButton2$visibility"
                                                            visible={ExpressionProperty({
                                                                "expression": { "expr": { "type": "function", "name": "_hasSomeRole", "parameters": [ { "type": "literal", "value": "Administrator" } ] }, "args": {} }
                                                            })}
                                                            contents={[
                                                                <$ActionButton key="p.MyFirstModule.Trainee_Overview.actionButton2"
                                                                    ...
                                                                    action={ActionProperty({
                                                                        "action": { "type": "deleteObject", "argMap": { "$object": { "widget": "p.MyFirstModule.Trainee_Overview.gallery1", "source": "object" } }, "config": { "closePage": true, "operationId": "rYSjiwVqll+8mnnnuBg4ww" }, "disabledDuringExecution": true },
                                                                        "abortOnServerValidation": true
                                                                    })} />
                                                            ]} />
                                                    ]}
