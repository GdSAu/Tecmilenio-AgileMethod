                                                            ...
                                                            <$Div key="p.MyFirstModule.TrainingEvent_Registration_Overview.layoutGrid2$row0$column0"
                                                                ...
                                                                content={[
                                                                    <$Text key="p.MyFirstModule.TrainingEvent_Registration_Overview.text40"
                                                                        ...
                                                                        caption={t([
                                                                            ExpressionProperty({
                                                                                "expression": { "expr": { "type": "function", "name": "+", "parameters": [ { "type": "function", "name": "+", "parameters": [ { "type": "function", "name": "+", "parameters": [ { "type": "literal", "value": "Registration for the " }, { "type": "variable", "variable": "currentObject", "path": "MyFirstModule.TrainingEvent_Course/MyFirstModule.Course/Title" } ] }, { "type": "literal", "value": " to " } ] }, { "type": "function", "name": "_format", "parameters": [ { "type": "variable", "variable": "currentObject", "path": "StartDate" }, { "type": "literal", "value": "{\"type\":\"date\"}" } ] } ] }, "args": { "currentObject": { "widget": "p.MyFirstModule.TrainingEvent_Registration_Overview.dataView1", "source": "object" } } }
                                                                            })
                                                                        ])}
                                                                        renderMode={"h1"} />,
                                                    ...
                                                    <$Div key="p.MyFirstModule.TrainingEvent_Registration_Overview.layoutGrid2$row1"
                                                        ...
                                                        content={[
                                                            <$Div key="p.MyFirstModule.TrainingEvent_Registration_Overview.layoutGrid2$row1$column0"
                                                                ...
                                                                style={undefined}
                                                                content={[
                                                                    <$Gallery key="p.MyFirstModule.TrainingEvent_Registration_Overview.gallery1"
                                                                        ...
                                                                        datasource={DatabaseObjectListProperty({
                                                                            ...
                                                                            "operationId": "r2sBFvLq4lGslJQC0ITgVg",
                                                                            "sort": [],
                                                                            "arguments": {
                                                                                "currentObject": [
                                                                                    "$TrainingEvent"
