                                ...
                                content={[
                                    <$Gallery key="p.MyFirstModule.Teacher_Overview.gallery1"
                                        ...
                                        datasource={DatabaseObjectListProperty({
                                            ...
                                            "operationId": "PqDEpIyc91u1qblpIX5VMA",
                                            "sort": []
                                        })}
                                        ...
                                        content={TemplatedWidgetProperty({
                                            ...
                                            "editable": false,
                                            "children": () => [
                                                <$Container key="p.MyFirstModule.Teacher_Overview.container4"
                                                    ...
                                                    onClick={undefined}
                                                    content={[
                                                        <$Container key="p.MyFirstModule.Teacher_Overview.container5"
                                                            ...
                                                            onClick={undefined}
                                                            content={[
                                                                <$Text key="p.MyFirstModule.Teacher_Overview.text11"
                                                                    ...
                                                                    renderMode={"h4"} />,
                                                                <$Text key="p.MyFirstModule.Teacher_Overview.text42"
                                                                    $widgetId="p.MyFirstModule.Teacher_Overview.text42"
                                                                    class={"mx-name-text42 spacing-outer-bottom-none"}
                                                                    style={undefined}
                                                                    caption={t([
                                                                        ExpressionProperty({
                                                                            "expression": { "expr": { "type": "function", "name": "+", "parameters": [ { "type": "literal", "value": "Email: " }, { "type": "variable", "variable": "currentObject", "path": "EmailAddress" } ] }, "args": { "currentObject": { "widget": "p.MyFirstModule.Teacher_Overview.gallery1", "source": "object" } } }
                                                                        })
                                                                    ])}
                                                                    renderMode={"p"} />
                                                            ]}
                                                            ariaHidden={false} />,
                                                        <$ActionButton key="p.MyFirstModule.Teacher_Overview.actionButton5"
                                        ...
                                        onClick={ListActionProperty({
                                            "action": { "type": "openPage", "argMap": { "param$Teacher": { "widget": "p.MyFirstModule.Teacher_Overview.gallery1", "source": "object" } }, "config": { "name": "MyFirstModule/Teacher_NewEdit.page.xml", "location": "modal", "resizable": true, "allowedRoles": [ "Administrator" ] }, "disabledDuringExecution": false },
