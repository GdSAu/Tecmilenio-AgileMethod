                            ...
                            <$DataView key="p.Administration.Account_Edit.dataView1"
                                        ...
                                        control={[
                                            <$Combobox key="p.Administration.Account_Edit.comboBox2"
                                                ...
                                                optionsSourceAssociationDataSource={DatabaseObjectListProperty({
                                                    ...
                                                    "scope": "p.Administration.Account_Edit.dataView1",
                                                    "operationId": "F4dkCMcoxlOu2xO+8gjXgg",
                                                    "sort": [
                                                        [
                                                            "Name",
                                                            "asc"
                                        ...
                                        control={[
                                            <$Combobox key="p.Administration.Account_Edit.comboBox3"
                                                ...
                                                optionsSourceAssociationDataSource={DatabaseObjectListProperty({
                                                    ...
                                                    "scope": "p.Administration.Account_Edit.dataView1",
                                                    "operationId": "Y1zeYSOS0lS6alvRyiyFqg",
                                                    "sort": []
                                                })}
                                                optionsSourceAssociationCaptionType={"attribute"}
                                                optionsSourceAssociationCaptionAttribute={ListAttributeProperty({
                                        ...
                                        control={[
                                            <$Combobox key="p.Administration.Account_Edit.comboBox4"
                                                ...
                                                optionsSourceAssociationDataSource={DatabaseObjectListProperty({
                                                    ...
                                                    "scope": "p.Administration.Account_Edit.dataView1",
                                                    "operationId": "SPzLmq9gTlWqqzrBxSY3CA",
                                                    "sort": [
                                                        [
                                                            "RawOffset",
                                                            "asc"
                                        ...
                                        contents={[
                                            <$ActionButton key="p.Administration.Account_Edit.microflowTrigger1"
                                                ...
                                                action={ActionProperty({
                                                    "action": { "type": "callMicroflow", "argMap": { "Account": { "widget": "$Account", "source": "object" } }, "config": { "operationId": "DZ5MFOBgGVGU5zGEAPiMMg", "allowedRoles": [ "Administrator" ] }, "disabledDuringExecution": false },
                                ...
                                footer={[
                                    <$ActionButton key="p.Administration.Account_Edit.saveButton1"
                                        ...
                                        icon={undefined}
                                        action={ActionProperty({
                                            "action": { "type": "saveChanges", "argMap": { "$object": { "widget": "p.Administration.Account_Edit.dataView1", "source": "object" } }, "config": { "operationId": "oYPS1g/sSFqChYDbelzi4A", "closePage": true }, "disabledDuringExecution": true },
                                            "abortOnServerValidation": true
                                        })} />,
                                    <$ActionButton key="p.Administration.Account_Edit.cancelButton1"
                                        ...
                                        icon={undefined}
                                        action={ActionProperty({
                                            "action": { "type": "cancelChanges", "argMap": {}, "config": { "operationId": "sdePDZgjz1S9hXXa6bu0hA", "closePage": true }, "disabledDuringExecution": true },
                                            "abortOnServerValidation": true
                                        })} />
                                ]} />
                        ]} />
...
export const cancelChangesOperationId = "MFaYHdy1jlmRrrcjosQqpQ";
