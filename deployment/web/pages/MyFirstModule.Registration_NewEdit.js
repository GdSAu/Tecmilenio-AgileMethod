...
const region$Main = (historyId) => (<PageFragment renderKey={historyId}>{[
    <$Div key="p20.MyFirstModule.Registration_NewEdit.layoutGrid1"
        $widgetId="p20.MyFirstModule.Registration_NewEdit.layoutGrid1"
        class={"mx-name-layoutGrid1 mx-layoutgrid mx-layoutgrid-fluid container-fluid"}
        style={undefined}
        content={[
            <$Div key="p20.MyFirstModule.Registration_NewEdit.layoutGrid1$row0"
                $widgetId="p20.MyFirstModule.Registration_NewEdit.layoutGrid1$row0"
                class={"row"}
                style={undefined}
                content={[
                    <$Div key="p20.MyFirstModule.Registration_NewEdit.layoutGrid1$row0$column0"
                        $widgetId="p20.MyFirstModule.Registration_NewEdit.layoutGrid1$row0$column0"
                        class={"col-lg col-md col"}
                        style={undefined}
                        content={[
                            <$DataView key="p20.MyFirstModule.Registration_NewEdit.dataView6"
                                ...
                                body={[
                                    <$FormGroup key="p20.MyFirstModule.Registration_NewEdit.textBox1$formGroup"
                                        $widgetId="p20.MyFirstModule.Registration_NewEdit.textBox1$formGroup"
                                        class={"mx-name-textBox1 mx-textbox"}
                                        style={undefined}
                                        control={[
                                            <$TextBox key="p20.MyFirstModule.Registration_NewEdit.textBox1"
                                    ...
                                    <$FormGroup key="p20.MyFirstModule.Registration_NewEdit.comboBox1$formGroup"
                                        $widgetId="p20.MyFirstModule.Registration_NewEdit.comboBox1$formGroup"
                                        class={"mx-name-comboBox1"}
                                        style={undefined}
                                        control={[
                                            <$Combobox key="p20.MyFirstModule.Registration_NewEdit.comboBox1"
                                    ...
                                    <$FormGroup key="p20.MyFirstModule.Registration_NewEdit.datePicker1$formGroup"
                                        $widgetId="p20.MyFirstModule.Registration_NewEdit.datePicker1$formGroup"
                                        class={"mx-name-datePicker1 mx-datepicker"}
                                        style={undefined}
                                        control={[
                                            <$DatePicker key="p20.MyFirstModule.Registration_NewEdit.datePicker1"
                                    ...
                                    <$FormGroup key="p20.MyFirstModule.Registration_NewEdit.radioButtons1$formGroup"
                                        ...
                                        style={undefined}
                                        control={[
                                            <$RadioButtonGroup key="p20.MyFirstModule.Registration_NewEdit.radioButtons1"
                                ...
                                hideFooter={false}
                                footer={[
                                    <$ConditionalVisibilityWrapper key="p20.MyFirstModule.Registration_NewEdit.actionButton1$visibility"
                                        $widgetId="p20.MyFirstModule.Registration_NewEdit.actionButton1$visibility"
                                        visible={ExpressionProperty({
                                            "expression": { "expr": { "type": "function", "name": "_hasSomeRole", "parameters": [ { "type": "literal", "value": "Administrator" } ] }, "args": {} }
                                        })}
                                        contents={[
                                            <$ActionButton key="p20.MyFirstModule.Registration_NewEdit.actionButton1"
                                    ...
                                    <$ActionButton key="p20.MyFirstModule.Registration_NewEdit.actionButton2"
...
export const cancelChangesOperationId = "lwv2r7tibFuJpp66Zimy2g";
export const style = {};
