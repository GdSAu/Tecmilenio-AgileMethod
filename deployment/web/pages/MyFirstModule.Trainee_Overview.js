                                ...
                                content={[
                                    <$Gallery key="p.MyFirstModule.Trainee_Overview.gallery1"
                                        ...
                                        datasource={DatabaseObjectListProperty({
                                            ...
                                            "operationId": "BOvMBtMnUFu5tv0gFpdkTA",
                                            "sort": []
                                        })}
                                                ...
                                                <$Container key="p.MyFirstModule.Trainee_Overview.container4"
                                                    ...
                                                    content={[
                                                        <$Container key="p.MyFirstModule.Trainee_Overview.container5"
                                                            ...
                                                            content={[
                                                                ...
                                                                <$Text key="p.MyFirstModule.Trainee_Overview.text42"
                                                                    ...
                                                                    caption={t([
                                                                        ExpressionProperty({
                                                                            "expression": { "expr": { "type": "function", "name": "+", "parameters": [ { "type": "literal", "value": "Address: " }, { "type": "variable", "variable": "currentObject", "path": "Address" } ] }, "args": { "currentObject": { "widget": "p.MyFirstModule.Trainee_Overview.gallery1", "source": "object" } } }
                                                                        })
                                                                    ])}
                                                                    renderMode={"p"} />,
                                                                <$Text key="p.MyFirstModule.Trainee_Overview.text1"
                                                                    ...
                                                                    caption={t([
                                                                        ExpressionProperty({
                                                                            "expression": { "expr": { "type": "function", "name": "+", "parameters": [ { "type": "literal", "value": "Email: " }, { "type": "variable", "variable": "currentObject", "path": "EmailAddress" } ] }, "args": { "currentObject": { "widget": "p.MyFirstModule.Trainee_Overview.gallery1", "source": "object" } } }
                                                                        })
                                                                    ])}
                                                                    renderMode={"span"} />
                                                            ]}
                                                        ...
                                                        <$ActionButton key="p.MyFirstModule.Trainee_Overview.actionButton2"
                                                            ...
                                                            action={ActionProperty({
                                                                "action": { "type": "deleteObject", "argMap": { "$object": { "widget": "p.MyFirstModule.Trainee_Overview.gallery1", "source": "object" } }, "config": { "closePage": true, "operationId": "yIddp8JNfFOozRKsVMdJlg" }, "disabledDuringExecution": true },
                                                                "abortOnServerValidation": true
                                                            })} />
                                                    ]}
                                                    ariaHidden={false} />
