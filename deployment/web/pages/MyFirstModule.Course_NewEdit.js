...
const region$Main = (historyId) => (<PageFragment renderKey={historyId}>{[
    <$Div key="p4.MyFirstModule.Course_NewEdit.layoutGrid1"
        $widgetId="p4.MyFirstModule.Course_NewEdit.layoutGrid1"
        class={"mx-name-layoutGrid1 mx-layoutgrid mx-layoutgrid-fluid container-fluid"}
        style={undefined}
        content={[
            <$Div key="p4.MyFirstModule.Course_NewEdit.layoutGrid1$row0"
                $widgetId="p4.MyFirstModule.Course_NewEdit.layoutGrid1$row0"
                class={"row"}
                style={undefined}
                content={[
                    <$Div key="p4.MyFirstModule.Course_NewEdit.layoutGrid1$row0$column0"
                        $widgetId="p4.MyFirstModule.Course_NewEdit.layoutGrid1$row0$column0"
                        class={"col-lg col-md col"}
                        style={undefined}
                        content={[
                            <$DataView key="p4.MyFirstModule.Course_NewEdit.dataView6"
                                ...
                                body={[
                                    <$FormGroup key="p4.MyFirstModule.Course_NewEdit.textBox1$formGroup"
                                        $widgetId="p4.MyFirstModule.Course_NewEdit.textBox1$formGroup"
                                        class={"mx-name-textBox1 mx-textbox"}
                                        style={undefined}
                                        control={[
                                            <$TextBox key="p4.MyFirstModule.Course_NewEdit.textBox1"
                                    ...
                                    <$FormGroup key="p4.MyFirstModule.Course_NewEdit.textBox2$formGroup"
                                        $widgetId="p4.MyFirstModule.Course_NewEdit.textBox2$formGroup"
                                        class={"mx-name-textBox2 mx-textbox"}
                                        style={undefined}
                                        control={[
                                            <$TextBox key="p4.MyFirstModule.Course_NewEdit.textBox2"
                                    ...
                                    <$FormGroup key="p4.MyFirstModule.Course_NewEdit.textBox3$formGroup"
                                        $widgetId="p4.MyFirstModule.Course_NewEdit.textBox3$formGroup"
                                        class={"mx-name-textBox3 mx-textbox"}
                                        style={undefined}
                                        control={[
                                            <$TextBox key="p4.MyFirstModule.Course_NewEdit.textBox3"
                                    ...
                                    <$FormGroup key="p4.MyFirstModule.Course_NewEdit.textBox4$formGroup"
                                        $widgetId="p4.MyFirstModule.Course_NewEdit.textBox4$formGroup"
                                        class={"mx-name-textBox4 mx-textbox"}
                                        style={undefined}
                                        control={[
                                            <$TextBox key="p4.MyFirstModule.Course_NewEdit.textBox4"
                                ...
                                hideFooter={false}
                                footer={[
                                    <$ActionButton key="p4.MyFirstModule.Course_NewEdit.actionButton1"
                                    ...
                                    <$ActionButton key="p4.MyFirstModule.Course_NewEdit.actionButton2"
...
export const cancelChangesOperationId = "Cw+WOSbMyVWyGsqwChxUHg";
export const style = {};
