                            ...
                            <$DataView key="p.Administration.ChangePasswordForm.dataView2"
                                ...
                                footer={[
                                        ...
                                        contents={[
                                            <$ActionButton key="p.Administration.ChangePasswordForm.microflowButton1"
                                                ...
                                                action={ActionProperty({
                                                    "action": { "type": "callMicroflow", "argMap": { "AccountPasswordData": { "widget": "$AccountPasswordData", "source": "object" } }, "config": { "operationId": "qpZgzRmN+lWAYabf9tX4Rg", "validate": "view", "allowedRoles": [ "Administrator" ] }, "disabledDuringExecution": false },
                                    ...
                                    <$ActionButton key="p.Administration.ChangePasswordForm.cancelButton1"
                                        ...
                                        icon={undefined}
                                        action={ActionProperty({
                                            "action": { "type": "cancelChanges", "argMap": {}, "config": { "operationId": "COBLQ2TuslecavTOCE0wmg", "closePage": true }, "disabledDuringExecution": true },
                                            "abortOnServerValidation": true
                                        })} />
                                ]} />
                        ]} />
...
export const cancelChangesOperationId = "fyaVElu2ZlWf9AzNhrgcOw";
