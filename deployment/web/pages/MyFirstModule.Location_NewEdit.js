...
const region$Main = (historyId) => (<PageFragment renderKey={historyId}>{[
    <$Div key="p.MyFirstModule.Location_NewEdit.layoutGrid1"
        $widgetId="p.MyFirstModule.Location_NewEdit.layoutGrid1"
        class={"mx-name-layoutGrid1 mx-layoutgrid mx-layoutgrid-fluid container-fluid"}
        style={undefined}
        content={[
            <$Div key="p.MyFirstModule.Location_NewEdit.layoutGrid1$row0"
                $widgetId="p.MyFirstModule.Location_NewEdit.layoutGrid1$row0"
                class={"row"}
                style={undefined}
                content={[
                    <$Div key="p.MyFirstModule.Location_NewEdit.layoutGrid1$row0$column0"
                        $widgetId="p.MyFirstModule.Location_NewEdit.layoutGrid1$row0$column0"
                        class={"col-lg col-md col"}
                        style={undefined}
                        content={[
                            <$DataView key="p.MyFirstModule.Location_NewEdit.dataView6"
                                ...
                                body={[
                                    <$FormGroup key="p.MyFirstModule.Location_NewEdit.textBox1$formGroup"
                                        $widgetId="p.MyFirstModule.Location_NewEdit.textBox1$formGroup"
                                        class={"mx-name-textBox1 mx-textbox"}
                                        style={undefined}
                                        control={[
                                            <$TextBox key="p.MyFirstModule.Location_NewEdit.textBox1"
                                    ...
                                    <$FormGroup key="p.MyFirstModule.Location_NewEdit.textBox2$formGroup"
                                        $widgetId="p.MyFirstModule.Location_NewEdit.textBox2$formGroup"
                                        class={"mx-name-textBox2 mx-textbox"}
                                        style={undefined}
                                        control={[
                                            <$TextBox key="p.MyFirstModule.Location_NewEdit.textBox2"
                                ...
                                hideFooter={false}
                                footer={[
                                    <$ActionButton key="p.MyFirstModule.Location_NewEdit.actionButton1"
                                        ...
                                        action={ActionProperty({
                                            "action": { "type": "saveChanges", "argMap": { "$object": { "widget": "p.MyFirstModule.Location_NewEdit.dataView6", "source": "object" } }, "config": { "operationId": "suL7/x1xAVmLIN2Kz/8Xpg", "closePage": true }, "disabledDuringExecution": true },
                                            "abortOnServerValidation": true
                                        })} />,
                                    <$ActionButton key="p.MyFirstModule.Location_NewEdit.actionButton2"
                                        ...
                                        icon={undefined}
                                        action={ActionProperty({
                                            "action": { "type": "cancelChanges", "argMap": {}, "config": { "operationId": "2TvnhqfF61GRr/tRn/Vmsw", "closePage": true }, "disabledDuringExecution": true },
                                            "abortOnServerValidation": true
                                        })} />
                                ]} />
                        ]} />
...
export const cancelChangesOperationId = "nYwPMkPRsFmC+7bxZ7scxw";
export const style = {};
export const parameters = {"$Location":"object"};
