...
const region$Main = (historyId) => (<PageFragment renderKey={historyId}>{[
    <$Div key="p.MyFirstModule.Trainee_NewEdit.layoutGrid1"
        $widgetId="p.MyFirstModule.Trainee_NewEdit.layoutGrid1"
        class={"mx-name-layoutGrid1 mx-layoutgrid mx-layoutgrid-fluid container-fluid"}
        style={undefined}
        content={[
            <$Div key="p.MyFirstModule.Trainee_NewEdit.layoutGrid1$row0"
                $widgetId="p.MyFirstModule.Trainee_NewEdit.layoutGrid1$row0"
                class={"row"}
                style={undefined}
                content={[
                    <$Div key="p.MyFirstModule.Trainee_NewEdit.layoutGrid1$row0$column0"
                        $widgetId="p.MyFirstModule.Trainee_NewEdit.layoutGrid1$row0$column0"
                        class={"col-lg col-md col"}
                        style={undefined}
                        content={[
                            <$DataView key="p.MyFirstModule.Trainee_NewEdit.dataView6"
                                ...
                                body={[
                                    <$FormGroup key="p.MyFirstModule.Trainee_NewEdit.textBox1$formGroup"
                                        $widgetId="p.MyFirstModule.Trainee_NewEdit.textBox1$formGroup"
                                        class={"mx-name-textBox1 mx-textbox"}
                                        style={undefined}
                                        control={[
                                            <$TextBox key="p.MyFirstModule.Trainee_NewEdit.textBox1"
                                    ...
                                    <$FormGroup key="p.MyFirstModule.Trainee_NewEdit.textBox2$formGroup"
                                        $widgetId="p.MyFirstModule.Trainee_NewEdit.textBox2$formGroup"
                                        class={"mx-name-textBox2 mx-textbox"}
                                        style={undefined}
                                        control={[
                                            <$TextBox key="p.MyFirstModule.Trainee_NewEdit.textBox2"
                                    ...
                                    <$FormGroup key="p.MyFirstModule.Trainee_NewEdit.textBox3$formGroup"
                                        $widgetId="p.MyFirstModule.Trainee_NewEdit.textBox3$formGroup"
                                        class={"mx-name-textBox3 mx-textbox"}
                                        style={undefined}
                                        control={[
                                            <$TextBox key="p.MyFirstModule.Trainee_NewEdit.textBox3"
                                ...
                                hideFooter={false}
                                footer={[
                                    <$ActionButton key="p.MyFirstModule.Trainee_NewEdit.actionButton1"
                                        ...
                                        action={ActionProperty({
                                            "action": { "type": "saveChanges", "argMap": { "$object": { "widget": "p.MyFirstModule.Trainee_NewEdit.dataView6", "source": "object" } }, "config": { "operationId": "AKqn0n4Ohla8uaA+v3kCKg", "closePage": true }, "disabledDuringExecution": true },
                                            "abortOnServerValidation": true
                                        })} />,
                                    <$ActionButton key="p.MyFirstModule.Trainee_NewEdit.actionButton2"
                                        ...
                                        icon={undefined}
                                        action={ActionProperty({
                                            "action": { "type": "cancelChanges", "argMap": {}, "config": { "operationId": "uLs8l6Z1GVK2HThwjgBDWQ", "closePage": true }, "disabledDuringExecution": true },
                                            "abortOnServerValidation": true
                                        })} />
                                ]} />
                        ]} />
...
export const cancelChangesOperationId = "BGrsgTX1tVOneZ9bCkD0Yw";
export const style = {};
export const parameters = {"$Trainee":"object"};
