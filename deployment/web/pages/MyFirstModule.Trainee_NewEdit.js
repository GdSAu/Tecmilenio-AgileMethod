                                ...
                                footer={[
                                    <$ActionButton key="p.MyFirstModule.Trainee_NewEdit.actionButton1"
                                        ...
                                        action={ActionProperty({
                                            "action": { "type": "saveChanges", "argMap": { "$object": { "widget": "p.MyFirstModule.Trainee_NewEdit.dataView6", "source": "object" } }, "config": { "operationId": "dk08xHlhe1+vNGurVzQ7PA", "closePage": true }, "disabledDuringExecution": true },
                                    ...
                                    <$ActionButton key="p.MyFirstModule.Trainee_NewEdit.actionButton2"
                                        ...
                                        icon={undefined}
                                        action={ActionProperty({
                                            "action": { "type": "cancelChanges", "argMap": {}, "config": { "operationId": "j0OcULMXOFWDEgpe6ZW3Uw", "closePage": true }, "disabledDuringExecution": true },
                                            "abortOnServerValidation": true
                                        })} />
                                ]} />
                        ]} />
