...
const region$Main = (historyId) => (<PageFragment renderKey={historyId}>{[
    <$Div key="p13.Administration.ChangeMyPasswordForm.layoutGrid1"
        $widgetId="p13.Administration.ChangeMyPasswordForm.layoutGrid1"
        class={"mx-name-layoutGrid1 mx-layoutgrid mx-layoutgrid-fluid container-fluid"}
        style={undefined}
        content={[
            <$Div key="p13.Administration.ChangeMyPasswordForm.layoutGrid1$row0"
                $widgetId="p13.Administration.ChangeMyPasswordForm.layoutGrid1$row0"
                class={"row"}
                style={undefined}
                content={[
                    <$Div key="p13.Administration.ChangeMyPasswordForm.layoutGrid1$row0$column0"
                        $widgetId="p13.Administration.ChangeMyPasswordForm.layoutGrid1$row0$column0"
                        class={"col-lg col-md col"}
                        style={undefined}
                        content={[
                            <$DataView key="p13.Administration.ChangeMyPasswordForm.dataView2"
                                ...
                                body={[
                                    <$FormGroup key="p13.Administration.ChangeMyPasswordForm.textBox2$formGroup"
                                        $widgetId="p13.Administration.ChangeMyPasswordForm.textBox2$formGroup"
                                        class={"mx-name-textBox2 mx-textbox"}
                                        style={undefined}
                                        control={[
                                            <$TextBox key="p13.Administration.ChangeMyPasswordForm.textBox2"
                                    ...
                                    <$FormGroup key="p13.Administration.ChangeMyPasswordForm.textBox3$formGroup"
                                        $widgetId="p13.Administration.ChangeMyPasswordForm.textBox3$formGroup"
                                        class={"mx-name-textBox3 mx-textbox"}
                                        style={undefined}
                                        control={[
                                            <$TextBox key="p13.Administration.ChangeMyPasswordForm.textBox3"
                                    ...
                                    <$FormGroup key="p13.Administration.ChangeMyPasswordForm.textBox1$formGroup"
                                        $widgetId="p13.Administration.ChangeMyPasswordForm.textBox1$formGroup"
                                        class={"mx-name-textBox1 mx-textbox"}
                                        style={undefined}
                                        control={[
                                            <$TextBox key="p13.Administration.ChangeMyPasswordForm.textBox1"
                                ...
                                hideFooter={false}
                                footer={[
                                    <$ConditionalVisibilityWrapper key="p13.Administration.ChangeMyPasswordForm.microflowButton1$visibility"
                                        ...
                                        contents={[
                                            <$ActionButton key="p13.Administration.ChangeMyPasswordForm.microflowButton1"
                                    ...
                                    <$ActionButton key="p13.Administration.ChangeMyPasswordForm.cancelButton1"
...
export const cancelChangesOperationId = "JlHCMtBzslSRXDHTLkquqA";
export const closeButton = "p13.Administration.ChangeMyPasswordForm.cancelButton1";
export const style = {};
