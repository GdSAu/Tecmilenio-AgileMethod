...
const region$Main = (historyId) => (<PageFragment renderKey={historyId}>{[
    <$Div key="p18.Administration.MyAccount.layoutGrid1"
        $widgetId="p18.Administration.MyAccount.layoutGrid1"
        class={"mx-name-layoutGrid1 mx-layoutgrid mx-layoutgrid-fluid container-fluid"}
        style={undefined}
        content={[
            <$Div key="p18.Administration.MyAccount.layoutGrid1$row0"
                $widgetId="p18.Administration.MyAccount.layoutGrid1$row0"
                class={"row"}
                style={undefined}
                content={[
                    <$Div key="p18.Administration.MyAccount.layoutGrid1$row0$column0"
                        $widgetId="p18.Administration.MyAccount.layoutGrid1$row0$column0"
                        class={"col-lg col-md col"}
                        style={undefined}
                        content={[
                            <$DataView key="p18.Administration.MyAccount.dataView1"
                                ...
                                body={[
                                    <$FormGroup key="p18.Administration.MyAccount.textBox2$formGroup"
                                        $widgetId="p18.Administration.MyAccount.textBox2$formGroup"
                                        class={"mx-name-textBox2 mx-textbox"}
                                        style={undefined}
                                        control={[
                                            <$TextBox key="p18.Administration.MyAccount.textBox2"
                                    ...
                                    <$FormGroup key="p18.Administration.MyAccount.textBox5$formGroup"
                                        $widgetId="p18.Administration.MyAccount.textBox5$formGroup"
                                        class={"mx-name-textBox5 mx-textbox"}
                                        style={undefined}
                                        control={[
                                            <$TextBox key="p18.Administration.MyAccount.textBox5"
                                    ...
                                    <$FormGroup key="p18.Administration.MyAccount.comboBox3$formGroup"
                                        $widgetId="p18.Administration.MyAccount.comboBox3$formGroup"
                                        class={"mx-name-comboBox3"}
                                        style={undefined}
                                        control={[
                                            <$Combobox key="p18.Administration.MyAccount.comboBox3"
                                    ...
                                    <$ConditionalVisibilityWrapper key="p18.Administration.MyAccount.microflowTrigger1$visibility"
                                        ...
                                        contents={[
                                            <$ActionButton key="p18.Administration.MyAccount.microflowTrigger1"
                                ...
                                hideFooter={false}
                                footer={[
                                    <$ActionButton key="p18.Administration.MyAccount.saveButton1"
                                    ...
                                    <$ActionButton key="p18.Administration.MyAccount.cancelButton1"
...
export const cancelChangesOperationId = "MgBdxrYFo12QwHO+p6qq4Q";
export const closeButton = "p18.Administration.MyAccount.cancelButton1";
export const style = {};
