...
const region$Main = (historyId) => (<PageFragment renderKey={historyId}>{[
    <$Div key="p36.MyFirstModule.Teacher_NewEdit.layoutGrid1"
        $widgetId="p36.MyFirstModule.Teacher_NewEdit.layoutGrid1"
        class={"mx-name-layoutGrid1 mx-layoutgrid mx-layoutgrid-fluid container-fluid"}
        style={undefined}
        content={[
            <$Div key="p36.MyFirstModule.Teacher_NewEdit.layoutGrid1$row0"
                $widgetId="p36.MyFirstModule.Teacher_NewEdit.layoutGrid1$row0"
                class={"row"}
                style={undefined}
                content={[
                    <$Div key="p36.MyFirstModule.Teacher_NewEdit.layoutGrid1$row0$column0"
                        $widgetId="p36.MyFirstModule.Teacher_NewEdit.layoutGrid1$row0$column0"
                        class={"col-lg col-md col"}
                        style={undefined}
                        content={[
                            <$DataView key="p36.MyFirstModule.Teacher_NewEdit.dataView6"
                                ...
                                body={[
                                    <$FormGroup key="p36.MyFirstModule.Teacher_NewEdit.textBox1$formGroup"
                                        $widgetId="p36.MyFirstModule.Teacher_NewEdit.textBox1$formGroup"
                                        class={"mx-name-textBox1 mx-textbox"}
                                        style={undefined}
                                        control={[
                                            <$TextBox key="p36.MyFirstModule.Teacher_NewEdit.textBox1"
                                    ...
                                    <$FormGroup key="p36.MyFirstModule.Teacher_NewEdit.textBox2$formGroup"
                                        $widgetId="p36.MyFirstModule.Teacher_NewEdit.textBox2$formGroup"
                                        class={"mx-name-textBox2 mx-textbox"}
                                        style={undefined}
                                        control={[
                                            <$TextBox key="p36.MyFirstModule.Teacher_NewEdit.textBox2"
                                ...
                                hideFooter={false}
                                footer={[
                                    <$ActionButton key="p36.MyFirstModule.Teacher_NewEdit.actionButton1"
                                    ...
                                    <$ActionButton key="p36.MyFirstModule.Teacher_NewEdit.actionButton2"
...
export const cancelChangesOperationId = "E0GQb4Ci8lWypA+qACH7kQ";
export const style = {};
