                                ...
                                footer={[
                                    <$ActionButton key="p.MyFirstModule.Teacher_NewEdit.actionButton1"
                                        ...
                                        action={ActionProperty({
                                            "action": { "type": "saveChanges", "argMap": { "$object": { "widget": "p.MyFirstModule.Teacher_NewEdit.dataView6", "source": "object" } }, "config": { "operationId": "1G0wsDi8xV+sCGce8JyhTQ", "closePage": true }, "disabledDuringExecution": true },
                                    ...
                                    <$ActionButton key="p.MyFirstModule.Teacher_NewEdit.actionButton2"
                                        ...
                                        icon={undefined}
                                        action={ActionProperty({
                                            "action": { "type": "cancelChanges", "argMap": {}, "config": { "operationId": "5k0wL2ELCl6fXPhks8T6iQ", "closePage": true }, "disabledDuringExecution": true },
                                            "abortOnServerValidation": true
                                        })} />
                                ]} />
                        ]} />
...
export const cancelChangesOperationId = "X6RaDgQijV2NszSbEkMcxw";
export const style = {};
export const parameters = {"$Teacher":"object"};
