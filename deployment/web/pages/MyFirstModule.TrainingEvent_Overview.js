...
import * as GalleryWidgetModule from "C:/Users/user/Mendix/LearnNow Training Management-main_3/deployment/web/widgets/com/mendix/widget/web/gallery/Gallery.mjs";
                                ...
                                contents={[
                                    <$ActionButton key="p.MyFirstModule.TrainingEvent_Overview.actionButton1"
                                        ...
                                        action={ActionProperty({
                                            "action": { "type": "createObject", "argMap": {}, "config": { "entity": "MyFirstModule.TrainingEvent", "operationId": "QcIeb36+eFipeCQUCLFhLQ", "pageSettings": { "name": "MyFirstModule/TrainingEvent_NewEdit.page.xml", "location": "content", "allowedRoles": [ "Administrator" ] }, "allowedRoles": [ "Administrator" ], "objectParameter": "param$TrainingEvent" }, "disabledDuringExecution": true },
                                ...
                                content={[
                                    <$Gallery key="p.MyFirstModule.TrainingEvent_Overview.gallery1"
                                        ...
                                        datasource={DatabaseObjectListProperty({
                                            ...
                                            "operationId": "N+WquiSoslaLLoBMkr1DfQ",
                                            "sort": []
                                        })}
                                                ...
                                                <$Container key="p.MyFirstModule.TrainingEvent_Overview.container4"
                                                    ...
                                                    content={[
                                                        <$Container key="p.MyFirstModule.TrainingEvent_Overview.container5"
                                                            ...
                                                            content={[
                                                                ...
                                                                <$Text key="p.MyFirstModule.TrainingEvent_Overview.text44"
                                                                    ...
                                                                    caption={t([
                                                                        ExpressionProperty({
                                                                            "expression": { "expr": { "type": "function", "name": "+", "parameters": [ { "type": "literal", "value": "Located at:\r\n" }, { "type": "variable", "variable": "currentObject", "path": "MyFirstModule.TrainingEvent_Location/MyFirstModule.Location/Address" } ] }, "args": { "currentObject": { "widget": "p.MyFirstModule.TrainingEvent_Overview.gallery1", "source": "object" } } }
                                                                        })
                                                                    ])}
                                                                    renderMode={"p"} />,
                                                        ...
                                                        <$ConditionalVisibilityWrapper key="p.MyFirstModule.TrainingEvent_Overview.actionButton2$visibility"
                                                            ...
                                                            contents={[
                                                                <$ActionButton key="p.MyFirstModule.TrainingEvent_Overview.actionButton2"
                                                                    ...
                                                                    caption={t([
                                                                        ExpressionProperty({
                                                                            "expression": { "expr": { "type": "literal", "value": "Registration" }, "args": {} }
                                                                        })
                                                                    ])}
                                                                    tooltip={TextProperty({
                                                                        "value": t([
                                                                    ...
                                                                    icon={undefined}
                                                                    action={ActionProperty({
                                                                        "action": { "type": "openPage", "argMap": { "param$TrainingEvent": { "widget": "p.MyFirstModule.TrainingEvent_Overview.gallery1", "source": "object" }, "param$TrainingEvent_2": { "widget": "p.MyFirstModule.TrainingEvent_Overview.gallery1", "source": "object" }, "param$TrainingEvent_3": { "widget": "p.MyFirstModule.TrainingEvent_Overview.gallery1", "source": "object" } }, "config": { "name": "MyFirstModule/TrainingEvent_Registration_Overview.page.xml", "location": "content", "allowedRoles": [ "Administrator", "Teacher" ] }, "disabledDuringExecution": true },
                                                                        "abortOnServerValidation": true
                                                                    })} />
                                                            ]} />,
                                                        ...
                                                        <$ActionButton key="p.MyFirstModule.TrainingEvent_Overview.actionButton3"
                                                            ...
                                                            action={ActionProperty({
                                                                "action": { "type": "deleteObject", "argMap": { "$object": { "widget": "p.MyFirstModule.TrainingEvent_Overview.gallery1", "source": "object" } }, "config": { "closePage": false, "operationId": "Mp5X8XU7I12+bYLCU7pAUQ" }, "disabledDuringExecution": true },
                                                                "abortOnServerValidation": true
                                                            })} />
                                                    ]}
                                                    ariaHidden={false} />
                                        ...
                                        onClick={ListActionProperty({
                                            "action": { "type": "openPage", "argMap": { "param$TrainingEvent": { "widget": "p.MyFirstModule.TrainingEvent_Overview.gallery1", "source": "object" } }, "config": { "name": "MyFirstModule/TrainingEvent_NewEdit.page.xml", "location": "content", "allowedRoles": [ "Administrator" ] }, "disabledDuringExecution": false },
