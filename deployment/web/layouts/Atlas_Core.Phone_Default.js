...
const region$Main = [
    <$ScrollContainer key="l39.Atlas_Core.Phone_Default.scrollContainer1"
        $widgetId="l39.Atlas_Core.Phone_Default.scrollContainer1"
        ...
        top={{
            "enabled": true,
            "content": [
                <$Header key="l39.Atlas_Core.Phone_Default.header1"
                    $widgetId="l39.Atlas_Core.Phone_Default.header1"
                    ...
                    leftWidgets={[
                        <$Placeholder key="l39.Atlas_Core.Phone_Default.HeaderLeft"
                            $widgetId="l39.Atlas_Core.Phone_Default.HeaderLeft"
                            content={PlaceholderProperty({
                                "id": "Atlas_Core.Phone_Default.HeaderLeft"
                            })} />
                    ]}
                    rightWidgets={[
                        <$Placeholder key="l39.Atlas_Core.Phone_Default.HeaderRight"
                            $widgetId="l39.Atlas_Core.Phone_Default.HeaderRight"
                            content={PlaceholderProperty({
        ...
        bottom={{
            "enabled": true,
            "content": [
                <$SimpleMenuBar key="l39.Atlas_Core.Phone_Default.simpleMenuBar1"
                    $widgetId="l39.Atlas_Core.Phone_Default.simpleMenuBar1"
        ...
        center={{
            "content": [
                <$Placeholder key="l39.Atlas_Core.Phone_Default.Main"
                    $widgetId="l39.Atlas_Core.Phone_Default.Main"
                    content={PlaceholderProperty({
