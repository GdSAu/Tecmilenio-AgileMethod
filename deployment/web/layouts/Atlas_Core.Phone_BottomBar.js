...
const region$Main = [
    <$ScrollContainer key="l24.Atlas_Core.Phone_BottomBar.scrollContainer1"
        $widgetId="l24.Atlas_Core.Phone_BottomBar.scrollContainer1"
        ...
        bottom={{
            "enabled": true,
            "content": [
                <$SimpleMenuBar key="l24.Atlas_Core.Phone_BottomBar.simpleMenuBar1"
                    $widgetId="l24.Atlas_Core.Phone_BottomBar.simpleMenuBar1"
        ...
        center={{
            "content": [
                <$Placeholder key="l24.Atlas_Core.Phone_BottomBar.Main"
                    $widgetId="l24.Atlas_Core.Phone_BottomBar.Main"
