...
const region$Main = [
    <$ScrollContainer key="l33.Atlas_Core.Tablet_BottomBar.layoutContainer"
        $widgetId="l33.Atlas_Core.Tablet_BottomBar.layoutContainer"
        ...
        bottom={{
            "enabled": true,
            "content": [
                <$SimpleMenuBar key="l33.Atlas_Core.Tablet_BottomBar.simpleMenuBar1"
                    $widgetId="l33.Atlas_Core.Tablet_BottomBar.simpleMenuBar1"
        ...
        center={{
            "content": [
                <$Placeholder key="l33.Atlas_Core.Tablet_BottomBar.Main"
                    $widgetId="l33.Atlas_Core.Tablet_BottomBar.Main"
