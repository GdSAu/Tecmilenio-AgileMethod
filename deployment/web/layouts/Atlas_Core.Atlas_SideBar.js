...
const region$Main = [
    <$ScrollContainer key="l31.Atlas_Core.Atlas_SideBar.layoutContainer"
        $widgetId="l31.Atlas_Core.Atlas_SideBar.layoutContainer"
        ...
        top={{
            "enabled": true,
            "content": [
                <$Fragment key="l31.Atlas_Core.Atlas_SideBar.snippetCall1"
                    $widgetId="l31.Atlas_Core.Atlas_SideBar.snippetCall1"
                    content={[
                        <$SprintrFeedback key="l31.Atlas_Core.FeedbackWidget.feedback1"
                            $widgetId="l31.Atlas_Core.FeedbackWidget.feedback1"
                ...
                <$Container key="l31.Atlas_Core.Atlas_SideBar.container4"
                    $widgetId="l31.Atlas_Core.Atlas_SideBar.container4"
                    class={"mx-name-container4 flex-row align-y-center"}
                    style={undefined}
                    renderMode={"div"}
                    onClick={undefined}
                    content={[
                        <$Container key="l31.Atlas_Core.Atlas_SideBar.container6"
                            $widgetId="l31.Atlas_Core.Atlas_SideBar.container6"
                            ...
                            onClick={undefined}
                            content={[
                                <$SidebarToggle key="l31.Atlas_Core.Atlas_SideBar.sidebarToggle6"
                                    $widgetId="l31.Atlas_Core.Atlas_SideBar.sidebarToggle6"
                                    buttonId={"l31.Atlas_Core.Atlas_SideBar.sidebarToggle6"}
                                    renderType={"button"}
                                    ...
                                    style={undefined}
                                    tabIndex={undefined} />,
                                <$Placeholder key="l31.Atlas_Core.Atlas_SideBar.Topbar"
                                    $widgetId="l31.Atlas_Core.Atlas_SideBar.Topbar"
                                    content={PlaceholderProperty({
                                        "id": "Atlas_Core.Atlas_SideBar.Topbar"
                                    })} />
                            ]}
                            ariaHidden={false} />,
                        <$Container key="l31.Atlas_Core.Atlas_SideBar.container5"
                            $widgetId="l31.Atlas_Core.Atlas_SideBar.container5"
                            ...
                            onClick={undefined}
                            content={[
                                <$Fragment key="l31.Atlas_Core.Atlas_SideBar.snippetCall3"
                                    $widgetId="l31.Atlas_Core.Atlas_SideBar.snippetCall3"
                                    content={[
                                        <$LanguageSelector key="l31.Atlas_Core.LanguageSelectorWidget.languageSelector1"
                                            $widgetId="l31.Atlas_Core.LanguageSelectorWidget.languageSelector1"
                                            languageOptions={DatabaseObjectListProperty({
                                                "dataSourceId": "l31.2",
                                                "entity": "System.Language",
                                                "operationId": "btmlmv6qRViQooWAzh+bNg",
                                                "sort": [
                                                    [
                                                        "Description",
                                                        "asc"
                                            ...
                                            languageCaption={ListExpressionProperty({
                                                "expression": { "expr": { "type": "variable", "variable": "currentObject", "path": "Description" }, "args": { "currentObject": { "widget": "l31.Atlas_Core.LanguageSelectorWidget.languageSelector1", "source": "object" } } },
                                                "dataSourceId": "l31.2"
                                            })}
                                            position={"bottom"}
                                            trigger={"click"}
        ...
        left={{
            "enabled": true,
            "content": [
                <$Container key="l31.Atlas_Core.Atlas_SideBar.container1"
                    $widgetId="l31.Atlas_Core.Atlas_SideBar.container1"
                    class={"mx-name-container1 sidebar-wrapper"}
                    style={undefined}
                    renderMode={"div"}
                    onClick={undefined}
                    content={[
                        <$Image key="l31.Atlas_Core.Atlas_SideBar.staticImage1"
                            $widgetId="l31.Atlas_Core.Atlas_SideBar.staticImage1"
                            datasource={"image"}
                            ...
                            style={undefined}
                            tabIndex={undefined} />,
                        <$SidebarToggle key="l31.Atlas_Core.Atlas_SideBar.sidebarToggle4"
                            $widgetId="l31.Atlas_Core.Atlas_SideBar.sidebarToggle4"
                            buttonId={"l31.Atlas_Core.Atlas_SideBar.sidebarToggle4"}
                            renderType={"button"}
                            ...
                            style={undefined}
                            tabIndex={undefined} />,
                        <$NavigationTree key="l31.Atlas_Core.Atlas_SideBar.navigationTree3"
                            $widgetId="l31.Atlas_Core.Atlas_SideBar.navigationTree3"
        ...
        center={{
            "content": [
                <$Placeholder key="l31.Atlas_Core.Atlas_SideBar.Main"
                    $widgetId="l31.Atlas_Core.Atlas_SideBar.Main"
                    content={PlaceholderProperty({
