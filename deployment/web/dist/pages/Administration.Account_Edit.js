...
import { CheckBox } from '../CheckBox-CbUpzs5f.js';
                                ...
                                /* @__PURE__ */ React.createElement(
                                  $Combobox,
                                  {
                                    ...
                                    optionsSourceAssociationDataSource: DatabaseObjectListProperty({
                                      ...
                                      "scope": "p.Administration.Account_Edit.dataView1",
                                      "operationId": "Fixdgta9a1a9qXNz3na4qQ",
                                      "sort": [
                                        [
                                          "Name",
                                          "asc"
                                ...
                                /* @__PURE__ */ React.createElement(
                                  $Combobox,
                                  {
                                    ...
                                    optionsSourceAssociationDataSource: DatabaseObjectListProperty({
                                      ...
                                      "scope": "p.Administration.Account_Edit.dataView1",
                                      "operationId": "EgyYNbEe4FKeYwrofFvQeQ",
                                      "sort": []
                                    }),
                                    optionsSourceAssociationCaptionType: "attribute",
                                    optionsSourceAssociationCaptionAttribute: ListAttributeProperty({
                                ...
                                /* @__PURE__ */ React.createElement(
                                  $Combobox,
                                  {
                                    ...
                                    optionsSourceAssociationDataSource: DatabaseObjectListProperty({
                                      ...
                                      "scope": "p.Administration.Account_Edit.dataView1",
                                      "operationId": "cilzeqlHTliO27UBeVTFcA",
                                      "sort": [
                                        [
                                          "RawOffset",
                                          "asc"
                                ...
                                /* @__PURE__ */ React.createElement(
                                  $ActionButton,
                                  {
                                    ...
                                    action: ActionProperty({
                                      "action": { "type": "callMicroflow", "argMap": { "Account": { "widget": "$Account", "source": "object" } }, "config": { "operationId": "ymz8uYWhd1SUuhr/RGAKvg", "allowedRoles": ["Administrator"] }, "disabledDuringExecution": false },
                        ...
                        footer: [
                          /* @__PURE__ */ React.createElement(
                            $ActionButton,
                            {
                              ...
                              icon: void 0,
                              action: ActionProperty({
                                "action": { "type": "saveChanges", "argMap": { "$object": { "widget": "p.Administration.Account_Edit.dataView1", "source": "object" } }, "config": { "operationId": "9qzjYTu4hV65X8Y41yF1+A", "closePage": true }, "disabledDuringExecution": true },
                                "abortOnServerValidation": true
                              })
                            }
                          ),
                          /* @__PURE__ */ React.createElement(
                            $ActionButton,
                            {
                              ...
                              icon: void 0,
                              action: ActionProperty({
                                "action": { "type": "cancelChanges", "argMap": {}, "config": { "operationId": "t6XZJyUci1CV2/7BJ8oGug", "closePage": true }, "disabledDuringExecution": true },
                                "abortOnServerValidation": true
                              })
                            }
                          )
...
const cancelChangesOperationId = "zqqv9qPc8FunAUcVPBGINQ";
