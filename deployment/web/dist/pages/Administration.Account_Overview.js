import { asProperty, fromConstant$, ensureAssociationId, isOffline, registerAssociationType, registerFilterAttribute, getFocus, getHTMLElement, ensure, isNavigableElement, isHTMLElement, reactExports, newId, reaction, useForceUpdate, tuple, Big, repeat, useStoreBackendValue, readUntracked, jsxRuntimeExports, classNames, NestedStoreProvider, when, observable, runInAction, asPluginWidgets, selectTranslation } from '../index-_VvUQn72.js';
import { PageFragment, Div, ExpressionProperty } from '../ScrollContainer-CWm8LcDE.js';
...
import { ListExpressionProperty } from '../ListExpressionProperty-K3KsB8n3.js';
...
import { DatagridWidgetModule } from '../Datagrid-nWPBXlot.js';
import { DatagridDateFilterWidgetModule, DatagridTextFilterWidgetModule } from '../DatagridTextFilter-BbNamXZi.js';
import { DatagridDropdownFilterWidgetModule } from '../DatagridDropdownFilter-CJLZHHte.js';
import { useLegacyResize, getBox } from '../DmsI6saM-BYC5s6jF.js';
import { usePersistentState } from '../FeedbackModule.ACT_Open_Feedback_Modal-Cw3PKCXV.js';
import { isRightToLeft } from '../EJisauA3-DYLOTI7Q.js';
import { content as content$1 } from '../Atlas_Core.Atlas_Default-BtI6w9xw.js';
import '../BkqAssms-BjvYwt-y.js';
import '../3ZSM-Jib-CY3WKdks.js';
                              ...
                              /* @__PURE__ */ React.createElement(
                                $Datagrid,
                                {
                                  ...
                                  datasource: DatabaseObjectListProperty({
                                    ...
                                    "operationId": "if1mybMBFV+1TvgI2hKJQQ",
                                    "sort": [
                                      [
                                        "FullName",
                                        "asc"
                                        ...
                                        /* @__PURE__ */ React.createElement(
                                          $DatagridDropdownFilter,
                                          {
                                            ...
                                            refOptions: DatabaseObjectListProperty({
                                              "dataSourceId": "p.15",
                                              "entity": "System.UserRole",
                                              "operationId": "18lCy6BPRVyf7tjLz4+VFQ",
                                              "sort": [
                                                [
                                                  "Name",
                                                  "asc"
                                        ...
                                        "children": () => [
                                          ...
                                          /* @__PURE__ */ React.createElement(
                                            $ActionButton,
                                            {
                                              ...
                                              action: ActionProperty({
                                                "action": { "type": "deleteObject", "argMap": { "$object": { "widget": "p.Administration.Account_Overview.dataGrid21", "source": "object" } }, "config": { "closePage": false, "operationId": "UIYXvL+spV689o/0u79P/A" }, "disabledDuringExecution": true },
                                                "abortOnServerValidation": true
                                              })
                                            }
                                          )
                                        ...
                                        contents: [
                                          /* @__PURE__ */ React.createElement(
                                            $ActionButton,
                                            {
                                              ...
                                              icon: void 0,
                                              action: ActionProperty({
                                                "action": { "type": "callMicroflow", "argMap": {}, "config": { "operationId": "Q3M6XuhiBluL/TBJsd5dtw", "validate": "view", "allowedRoles": ["Administrator"] }, "disabledDuringExecution": true },
                                                "abortOnServerValidation": true
                                              })
                                            }
                                          )
                                        ...
                                        contents: [
                                          /* @__PURE__ */ React.createElement(
                                            $ActionButton,
                                            {
                                              ...
                                              icon: void 0,
                                              action: ActionProperty({
                                                "action": { "type": "callMicroflow", "argMap": {}, "config": { "operationId": "wQB60zShale+0FMt297DdQ", "validate": "view", "allowedRoles": ["Administrator"] }, "disabledDuringExecution": true },
                                                "abortOnServerValidation": true
                                              })
                                            }
                                          )
